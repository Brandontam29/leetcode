...
print(hammingWeight2(0b00000000000010000000000000001011))
print(hammingWeight2(0b00001000000000000000000000001011))
print(hammingWeight2(0b00111000000010000010010000001011))
